...
- **Types client → serveur** : `chat_message`, `typing_start/stop`, `moderation_action`
- **Types serveur → client** : `room_joined`, `chat_message`, `user_joined/left`, `typing_start/stop`, `moderation_action`, `error`
