...
export default function Home() {
  ...
  return (
    <main className="overflow-y-scroll bg-sky-900">
      ...
      <div
        className="w-[100vw] md:min-h-[100vh] pt-10 px-10 bg-sky-700 flex flex-col justify-center items-center opacity-0 transition-opacity duration-500 sticky top-0"
