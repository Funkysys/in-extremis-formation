...
const ThirdPart: React.FC = () => {
  return (
    <div className="w-[100vw] min-h-[100vh] bg-sky-600 flex flex-col justify-center items-center">
      <h3 className="text-xl md:text-3xl text-white text-center mb-6 mt-6">
      ...
      <div className="relative w-[100vw] h-[20vh]  xl:w-[70vw] xl:h-[30vh]">
